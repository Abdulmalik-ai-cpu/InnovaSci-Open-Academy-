...
DECLARE
    ...
    correct_password_hash TEXT := '$2b$12$uihcUmoK81Q4.aFqzAVibuo01Eol6SJ.KwFzDi9Wg8tMMh5P79Uj2';
BEGIN
    ...
    IF admin_user_id IS NULL THEN
        ...
        INSERT INTO users (id, email, "passwordHash", role, status, "createdAt", "updatedAt") VALUES
            (admin_user_id, 'abdulmalikmusba@gmail.com', correct_password_hash, 'ADMIN', 'ACTIVE', NOW(), NOW());
        RAISE NOTICE 'Admin user created';
    ELSE
        -- Update password hash to correct value
        UPDATE users SET "passwordHash" = correct_password_hash, role = 'ADMIN', status = 'ACTIVE' WHERE id = admin_user_id;
